...
<html lang="en">
<head>
	<?php $this->load->view('logistik/includes/head'); ?>
</head>
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			<?php $this->load->view('logistik/includes/header'); ?>
		</nav>
		<!-- /.navbar -->
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<!-- Sidebar Menu -->
				<?php $this->load->view('logistik/includes/menu'); ?>
				<!-- /.sidebar-menu -->
			</div>
			<!-- /.sidebar -->
		</aside>
		...
		<div class="content-wrapper">
			...
			<?php $this->load->view('logistik/includes/breadcrumb'); ?>

			<!-- Main content -->
			<section class="content">
				<?php $this->load->view('logistik/'.$logistik); ?>
			</section>
			<!-- /.content -->
		</div>
		<!-- /.content-wrapper -->
	...
	<!-- REQUIRED SCRIPTS -->
	<?php $this->load->view('logistik/includes/foot'); ?>
</body>
</html>
