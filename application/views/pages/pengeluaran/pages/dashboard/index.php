  ...
  <div class="row">
    <div class="col-lg-4 col-4">
      ...
      <div class="small-box bg-info">
        <div class="inner">
          <h3><?php echo $count_data_pengeluaran; ?></h3>
        ...
        <a href="<?php echo base_url('pengeluaran/data_pengeluaran') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-4 col-4">
      ...
      <div class="small-box bg-success">
        ...
        <a href="<?php echo base_url('pengeluaran/vendor') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <?php echo form_close(); ?>
  </div>
