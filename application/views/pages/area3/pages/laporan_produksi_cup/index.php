<div class="container-fluid">
	<div class="row">
		<div class="col-md-5 mb-4">
			<?php echo form_open('Area3/Laporan_produksi_cup/get_data_report',['id' => 'form-filter']) ?>
			...
			<div class="card">
				<div class="card-body">
					<div class="table-responsive">
						<table id="table-data" class="table table-hover table-striped table-bordered border-collapse" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 200%;" data-url="<?php echo base_url('Area3/Laporan_produksi_cup/get_data_report') ?>">
							<thead>
								<tr>
									<th></th>
									<th></th>
	...
	$(document).ready(function(){
		...
		table = $('#table-data').DataTable({
			...
			buttons: [
			{
				extend: 'excelHtml5',
				className : 'mb-2',
				title : 'Report Data Produksi Cup Tanggal ' + '\n' + start_date + ' - ' + end_date,
			},
			{
				extend: 'pdfHtml5',
			...
			{ 
				"title" : "Tanggal Pembuatan Nomor Kantong",
				"data": "tanggal_pembuatan",
				"class": "text-center",
			},
			{ 
				"title" : "Tanggal Nomor Kantong Di Storage",
				"data": "tanggal_sedang_digunakan",
				"class": "text-center",
			},
			{ 
				"title" : "Tanggal Nomor Kantong Masuk Filler",
